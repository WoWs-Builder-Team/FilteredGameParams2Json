CONSUMABLE_KEYS = ["artilleryDistCoeff", "timeFromHeaven", "regenerationHPSpeed", "regenerationRate", "visionDistance", "updateFrequency", "areaDamageMultiplier", "bubbleDamageMultiplier" "dogFightTime", "fightersNum", "radius", "timeDelayAttack", "timeWaitDelayAttack", "distShip", "backwardEngineForsag", "forwardEngineForsag", "forwardEngineForsagMaxSpeed" "backwardEngineForsagMaxSpeed", "lifeTime", "radius", "speedLimit", "workTime", "distTorpedo", "boostCoeff", "buoyancyRudderResetTimeCoeff", "buoyancyRudderTimeCoeff", "maxBuoyancySpeedCoeff", "underwaterMaxRudderAngleCoeff",  "numConsumables", "reloadTime", "workTime", "iconIDs", "descIDs", "group"]
